...
export default function Home(){
    ...
    return (
      <div className="width-full height-848 display-flex space-around">
        <div className="height-840 mobile-container display-flex space-around align-center width-1300">
            ...
            <div className="border-radius-10 upload-status">
              ...
              <div className="margin-left-34 width-240 height-60 display-flex space-around align-center">
                { isLoading ? (
                  ...
                  <div className="purple-background border-radius-10 height-40 width-140">
            ...
            <div className="white-background summary-box border-radius-10 height-484 width-430">
                ...
                {summary != null ? (
                  <div onClick={(e) => speak(e)} className="display-flex space-around align-center height-74">
                    <div className="purple-color font-size-24"><IonIcon name="mic"/></div>
                  </div>
                ):(
